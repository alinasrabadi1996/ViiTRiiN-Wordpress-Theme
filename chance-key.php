...
if($result == 1) {
    switch ($discount) {
        case '1001':
            $sms_text = "تبریک!\nکد تخفیف $coupon_code\nارسال رایگان برای خریدهای بالای صد هزار تومان، به تمامی نقاط کشور\nاعتبار ۴۸ ساعت";
            break;
        case '1002':
        ...
        case '1005':
            ...
            break;
        case '1006':
            $sms_text = "تبریک!\nکد تخفیف رژ لب کلیک کلیک دوسه: $coupon_code\nاعتبار ۴۸ساعت";
            break;
        case '1007':
            $sms_text = "تبریک!\nکد تخفیف رژ لب مینرال جامد دوسه: $coupon_code\nاعتبار ۴۸ساعت";
            break;
        case '1008':
            $sms_text = "تبریک!\nکد تخفیف کرم پودر تیوپی آمیتیس: $coupon_code\nاعتبار ۴۸ساعت";
            break;
        case '1009':
            $sms_text = "تبریک!\nکد تخفیف $coupon_code\n۵۰ هزار تومان تخفیف بر روی سبد خرید حداقل صد و پنجاه هزار تومان\nاعتبار ۴۸ ساعت";
            break;
    }
