...
<div id="page-cart" class="page-content-inner">
	<div class="row">
		<div class="col-md-8">
			<div class="col-container wcard">
				<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
					...
					<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents cart-list" cellspacing="0">
						<tbody>
							...
							<?php
							// BRAND MESSAGE (CHAPTER) "1 / 3"
							$brand_msg = false;
							foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
								$_product   = apply_filters( 'woocommerce_cart_item_product', $cart_item['data'], $cart_item, $cart_item_key );
								$product_id = apply_filters( 'woocommerce_cart_item_product_id', $cart_item['product_id'], $cart_item, $cart_item_key );

                                // BRAND MESSAGE (CHAPTER) "2 / 3"
                                if(has_term('chapter', 'product_cat', $product_id))
							        $brand_msg = true;
							...
							<tr>
								<td colspan="6" class="actions">
									...
									<button style="opacity: 0;" type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
				...
				<?php
				// BRAND MESSAGE (CHAPTER) "3 / 3"
				if($brand_msg == true)
				    echo '<p class="coupon-description" style="background: #e45151;">آماده ارسال از یک تا دو روز آینده</p>';
				?>
		...
		<div class="col-md-4">
			<div id="sidebar" class="sidebar">
				<div class="cart-collaterals col-container wcard sidebar__inner">
						<?php
							/**
							 * Cart collaterals hook.
							 *
							 * @hooked woocommerce_cross_sell_display
							 * @hooked woocommerce_  - 10
							 */
