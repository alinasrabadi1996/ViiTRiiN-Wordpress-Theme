        ...
        <div class="col-lg-6 col-md-6 col-sm-6 clear-boxing">
            ...
            if ( $loop->have_posts() ) :
                ...
                <div class="product-presentation">
                    <a href="<?php if($banner_link = get_field('banner_permalink')) echo $banner_link; ?>"><img src="<?php get_the_post_thumbnail_url($post->ID, 'full'); ?>" class="product-presentation-image"></a>
                </div>
                <?php
                endwhile;
            endif; ?>
